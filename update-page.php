    ...
    <div class="container">
        ...
        <form action="update-page.php" method="post">
           <div class="form-id">
            ...
            <input type="number" name="id"> <input class="submit-btn" type="submit" name="submit" value="show">
        ...
        if(isset($_REQUEST['submit'])){
         ...
         <div class="formsection">
            <form action="update-to-page.php" method="post">
                <div class="form-id">
...
<?php }} }else{
    echo " hey baby input your id first ";
}
